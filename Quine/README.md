# A quine is a computer program which takes no input and produces a copy of its own source code as its only output. These are often known as "self-replicating programs".
